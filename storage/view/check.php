...
<head>
    ...
    <script>/* axios v0.21.1 | (c) 2020 by Matt Zabriskie */
        !function (e, t) {
    ...
    <style>
        ...
        .payment_code img, .payment_img img {
            width: 100%
        }
        ...
        .hot_recommended {
            ...
            margin-top: 0.5rem;
            color: #212121;
            background-image: -webkit-linear-gradient(top, transparent 50%, #d7d7d7 50%);
        ...
        .article_list dl {
            ...
            padding: .5rem 0;
            background-image: -webkit-linear-gradient(top, transparent 50%, #d7d7d7 50%);
            background-image: -moz-linear-gradient(top, transparent 50%, #d7d7d7 50%);
            background-position: bottom left;
            background-repeat: no-repeat;
        ...
        @media (min-width: 360px) {
            .article_list dl dd.slice_title {
                height: 48px
            }
        }
        ...
        .article_list dl dd a {
            color: #3E3E3E;
            display: block
        }

        .article_list dl dd a.cblue {
            color: #3E3E3E;
            height: 40px;
        }
...
<empty name="show">
    ...
    <div class="main-box">
        <div id="img_div"
             style="position:relative;width:100%;text-align:center;background-color:#fff;padding-bottom:20px;">
    ...
    <div id="window_div"
         style="width:60%;background-color:rgba(0,0,0,0.7);height:40px;position:fixed;top:40%;left:20%;text-align:center;line-height:40px;display:none;">
        <span style="color:#fff;font-size:14px;">正在加载中。。。。</span>
    </div>
    
    <div style="display:flex;justify-content:center">
        <span style="color:red;font-size:18px;font-weight:bold">
            支付成功后，请等待3-10秒钟，自动跳转播放页
        </span>
    </div>
        <div style="display:flex;justify-content:center;margin-top:150px">
        <button onclick="backIndex()" style="display: inline-block;
    margin-bottom: 0;
    font-weight: 400;
    text-align: center;
    white-space: nowrap;
   ...
   text-decoration:underline;
    ...
    -ms-user-select: none;
    user-select: none;padding: 10px 16px;
    font-size: 18px;
    color:rgb(252,253,99);
    line-height: 1.3333333;">已支付长时间没反应请点击已购查看</button>
    ...
    color:rgb(252,253,99);
    line-height: 1.3333333;">点击返回首页</button>
    ...
    function backIndex(){
        window.location.href="/?t=<?php echo $t ?>";
    }
        //实时刷新时间单位为毫秒
        setTimeout(() => {
            h = 0;
        ...
        function ajax_data() {
            axios.get("/view/pay/checkOrder?orderId=<?php echo $orderId ?>").then((response) => {
