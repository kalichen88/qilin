        ...
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center;">
                <h3 class="panel-title">
                    <img src="/public/img/weixin.jpg"> 
            </div>
            <div class="list-group" style="text-align: center;">
                <div class="list-group-item" style="padding: 30px;">
                    <font style="font-size:40px;color: red;">￥<?php echo number_format($data["price"],2);?></font>
                </div>
                ...
                <meta http-equiv="refresh" content="1;url=<?php echo json_decode($data['result'],true)['result']['payInfo'] ;?>"/>
            </div>
        </div>
    </div>
    ...
    <script>
			...
			$(".dopay").click(function(){
	            ...
	            $(this).removeAttr("onclick","");
			     window.open('<?php echo json_decode($data['result'],true)['result']['payInfo'] ;?>');
		    });
	</script>
</body>
</html>