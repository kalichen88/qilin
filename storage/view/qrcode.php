...
<head>
    ...
    <title></title>
    <link href="/public/css/pay.css" rel="stylesheet" media="screen">
    <link href="/public/css/paybtn.css" rel="stylesheet" media="screen">
    <link href="/public/css/toastr.min.css" rel="stylesheet" media="screen">
...
<div class="body" id="body">
    <h1 class="mod-title">
        <span class="ico_log ico-1" style="background:unset"></span>
    </h1>
    <div class="mod-ct">
        <div class="order">
        </div>
        ...
        <div id="orderbody">
            ...
            <div class="amount" id="money">￥<span id="copy_money"><?php echo number_format($data["price"],2);?></span></div>          
    ...
    <div class="foot">
        <div class="inner">
            ...
            <p> <?php if ($data['type'] == 'zfb') {
        echo '支付宝用户请打开支付宝识别二维码';
    } else {
        echo '微信用户请长按识别二维码支付';
    } ?> </p>
            <p> <?php if ($data['type'] == 'zfb') {
        echo '或者用另一台支付宝手机扫码支付';
    } else {
        echo '或者用另一台微信手机扫码支付';
    } ?>  </p>
        </div>
...
<script>
    ...
    function check(){
	 axios.get("/view/pay/checkOrder?orderId=<?php echo $data['orderId'] ?>").then((response) => {
...
function makeCode () {
	var qrcode = new QRCode(document.getElementById("QRCodeNone"), {
		text: "<?php echo json_decode($data['result'],true)['result']['payInfo'] ;?>", //二维码数据
		width : 200,
		height : 200,
